...
// $this->telegram_bot->sendMsgTelegram('asdasd');
...
class Telegram_bot {
	...
	public function sendMsgTelegram($text){
			
		// $bot_id 	= "475544040:AAFWjMYPBRbFLsYrulA5ilQ_qPt90wW4Nz8"; // doni-r_Bot
		$bot_id 	= "543877086:AAEEwTIWKYpQe3SvDD-7FF8WyjLHavuGeTg"; // amren_admin_bot

		#BotInfo
		// https://api.telegram.org/bot543877086:AAEEwTIWKYpQe3SvDD-7FF8WyjLHavuGeTg/getUpdates


		// $chat_id 	= '226729725'; // Asep
		$chat_id 	= '438567296'; // Doni

		$telmassege = "Relax your doing fine";
		$content  = array('chat_id' => $chat_id, 'text' => $telmassege);
